...
<div class="w3-container w3-white">
    <a href="index.html" class="w3-bar-item w3-button w3-hover-none w3-left w3-padding-14" title="Home" style="width:77px">
 ...
 <!-- Page Content -->
  <div class="w3-padding-large" id="main">
    ...
    <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
      <h1 class="w3-jumbo"><span class="w3-hide-small"></span>Username</h1>
     
    
      <img src="Imgs\user.png" alt="kd_icon" class="w3-image" width="100">
...
<form class="modal-content" action="/action_page.php">
    <div class="container">
      ...
      <output type="text" placeholder="Enter Email" name="email" required>

      <label for="psw"><b>Password</b></label>
      <output type="password" placeholder="Enter Password" name="psw" required>

      <label for="psw-repeat"><b>Repeat Password</b></label>
      <output type="password" placeholder="Repeat Password" name="psw-repeat" required>
